...
public class mergesort
{
    ...
    public static void ordenacao(pokemon[] array, int left, int right) 
    {
        ...
        if (left < right) 
        {
            ...
            ordenacao(array, left, middle);

            // Ordena a segunda metade
            ordenacao(array, middle + 1, right);
        ...
        try  
        { 
            FileWriter fw  = new FileWriter("844871_mergesortxt "); 
    ...
    // Função auxiliar para juntar os subarrays ordenados
    public static void merge(pokemon[] array, int left, int middle, int right) {
        ...
        {
            comp += 5; 
            if (leftArray[i].getTypes1().compareTo(rightArray[j].getTypes1()) <= 0)
            {
                if(leftArray[i].getTypes1().compareTo(rightArray[j].getTypes1()) == 0)
                {
                    if (leftArray[i].getNome().compareTo(rightArray[j].getNome()) < 0)
                    {
                        array[k] = leftArray[i];
                        i++;
                        mov++;
